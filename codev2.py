...
# The following 2 predictions are predicting based on the trained model
...
# Below are different types of ways of prediction
# The Combined CH Buffer proved to be the most accurate

'''
# band buffer prediction
